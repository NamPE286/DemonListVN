  ...
  return (
    <div className="mainlistPanel">
      ...
      <section title={`${levels[0].name} by ${levels[0].creator} - ${levels[0].points}pt`}>
        ...
        <a className="smalltop">#1</a><a>{`${processTitle(levels[0].name)} by ${processAuthor(levels[0].creator)} - ${levels[0].points}pt`}</a>
      </section>
      <section title={`${levels[1].name} by ${levels[1].creator} - ${levels[1].points}pt`}>
        ...
        <div className="fadeEffect1"></div>
        <a className="smalltop">#2</a><a>{`${processTitle(levels[1].name)} by ${processAuthor(levels[1].creator)} - ${levels[1].points}pt`}</a>
      </section>
      <section title={`${levels[2].name} by ${levels[2].creator} - ${levels[2].points}pt`}>
        ...
        <div className="fadeEffect1"></div>
        <a className="smalltop">#3</a><a>{`${processTitle(levels[2].name)} by ${processAuthor(levels[2].creator)} - ${levels[2].points}pt`}</a>
      </section>
      <section title={`${levels[3].name} by ${levels[3].creator} - ${levels[3].points}pt`}>
        ...
        <div className="fadeEffect1"></div>
        <a className="smalltop">#4</a><a>{`${processTitle(levels[3].name)} by ${processAuthor(levels[3].creator)} - ${levels[3].points}pt`}</a>
      </section>
      <section title={`${levels[4].name} by ${levels[4].creator} - ${levels[4].points}pt`}>
        ...
        <div className="fadeEffect1"></div>
        <a className="smalltop">#5</a><a>{`${processTitle(levels[4].name)} by ${processAuthor(levels[4].creator)} - ${levels[4].points}pt`}</a>
      </section>
    </div>
  )
}
