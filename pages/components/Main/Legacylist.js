                    ...
                    return (
                      <div className="levelWrapper" key={i}>
                        <div className='levelCard' onClick={toggle_visibility}>
                          <Image src={`https://i.ytimg.com/vi/${data[0][i].thumbnail}/hqdefault.jpg`} alt="" layout="fill" objectFit='cover'></Image>
                        ...
                        <div>
                          <div className="lvinfo" id={`lvf${i}`}>
                            <iframe
                              width="560"
                              height="315"
                              src={`https://www.youtube.com/embed/${data[0][i].thumbnail}&autoplay=1`}
                              srcDoc={`<style>*{padding:0;margin:0;overflow:hidden}html,body{height:100%}img,span{position:absolute;width:100%;top:0;bottom:0;margin:auto}span{height:1.5em;text-align:center;font:48px/1.5 sans-serif;color:white;text-shadow:0 0 0.5em black}</style><a href=https://www.youtube.com/embed/${data[0][i].thumbnail}?autoplay=1><img src=https://img.youtube.com/vi/${data[0][i].thumbnail}/hqdefault.jpg><span>▶</span></a>`}
                              frameBorder="0"
